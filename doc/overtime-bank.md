...
Per database gia' esistenti, applicare `backend/db/migrations/20260520_overtime_bank.sql`. `backend/db/init.sql` contiene gia' lo schema completo per installazioni pulite.
